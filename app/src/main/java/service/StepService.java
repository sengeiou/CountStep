...
import com.example.countstep.MainActivity;
...
import accelerometer.StepCount;
import accelerometer.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener {
    ...
    private void initNotification() {
        ...
        mBuilder = new NotificationCompat.Builder(this).setChannelId(CHANNEL_ONE_ID);
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
     ...
     */
    private void isCall() {
        String time = this.getSharedPreferences(Constants.Common.FILE_NAME, Context.MODE_PRIVATE).getString(Constants.Common.ACHIEVE_TIME, "21:00");
        String plan = this.getSharedPreferences(Constants.Common.FILE_NAME, Context.MODE_PRIVATE).getString(Constants.Common.PLAN_STEP, "7000");
        String remind = this.getSharedPreferences(Constants.Common.FILE_NAME, Context.MODE_PRIVATE).getString(Constants.Common.REMIND, "1");
//        Logger.d("time=" + time + "\n" +
...
//        }
        ...
        String plan = this.getSharedPreferences(Constants.Common.FILE_NAME, Context.MODE_MULTI_PROCESS).getString(Constants.Common.PLAN_STEP, "7000");
...
//            Logger.d("tempStep" + tempStep);
    ...
    private void addBasePedometerListener() {
        ...
        boolean isAvailable = sensorManager.registerListener((SensorEventListener) mStepCount.getStepDetector(), sensor,

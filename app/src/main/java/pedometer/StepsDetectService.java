...
public class StepsDetectService extends Service {
	...
	public void registerDetector() {
        ...
        mSensorManager.registerListener((SensorEventListener) mStepDetector, mSensor, SensorManager.SENSOR_DELAY_FASTEST);
 	}
	...
	public void unRegisterDector(){
		if(mStepDetector != null && mSensorManager != null){
			...
			mSensorManager.unregisterListener((SensorEventListener) mStepDetector);
		}
	}
